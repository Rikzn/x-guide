export default function Map () {
  ...
  function createBalloon (Map) {
    ...
    let MyBalloonLayout = ymaps.templateLayoutFactory.createClass(
      ...
      let MyBalloonContentLayout = ymaps.templateLayoutFactory.createClass('<div class="contacts__map-balloon-header">$[properties.balloonHeader]</div><div class="contacts__map-balloon-content">$[properties.balloonContent]</div>');
